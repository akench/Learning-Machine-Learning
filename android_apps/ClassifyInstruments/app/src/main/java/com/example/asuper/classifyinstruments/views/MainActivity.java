...
import com.example.asuper.classifyinstruments.BuildConfig;
...
//		String path;
//        path = Environment.getExternalStorageState() + "/images/myimage.jpg";
...
//		String path = data.getExtras().getParcelable(MediaStore.EXTRA_OUTPUT);
